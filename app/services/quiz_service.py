...
class QuizService:
    ...
    def get_quiz_by_id(self, quiz_id: int) -> Dict[str, Any]:
        ...
        :return: Serialized quiz data as a dictionary.
        """
        quiz = get_object_or_404(QuizModel, id=quiz_id)
        serializer = QuizSerializer(quiz)
        return serializer.data

    def create_quiz(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """
        Create a new quiz.
    ...
    def update_quiz(self, quiz_id: int, data: Dict[str, Any]) -> Dict[str, Any]:
        """
